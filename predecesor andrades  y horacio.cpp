/*  
    NOMBRE:         HORACIO LÓPEZ MORENO && KEVIN ARLEY ANDRADES MONDRAGON
    INSTITUCIÓN:    INIGENIRÍA DE SISTEMAS
    TEMA:           PROYECTO FINAL DE ARBOLES.CC
*/
...
if ((aux4->goles > temp )){
	...
	remplazo=aux4;
        system("cls");
         cout<<"numero "<<remplazo->goles<<endl;
    }
     if (aux4 -> izq != NULL)
    {
